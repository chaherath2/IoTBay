...
public class DBpaymentManager {
    ...
    /**
     * Get payment amount and other details from the form, create a payment object from the order,
     * associate it with the order object, and store it in the database.
     * @param order
     * @throws SQLException
     */
    ...
    /**
     * Find corresponding payment information and return the payment object.
     * @param paymentId
     * @return
     * @throws SQLException
     */
    ...
    /**
     * Find corresponding payment information based on the order ID and return a List of Payment objects.
     * @param orderId
     * @return
     * @throws SQLException
     */
