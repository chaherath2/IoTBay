...
<nav class="custom-nav navbar navbar-expand-lg ">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav nav-items-container ms-auto">
                <li class="nav-item">
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner carousel-item-custom">
        <div class="carousel-item active">
            <img src="imgs/img3.jpg" class="d-block w-100" alt="image of computer components">
        </div>
...
<a class="btn btn-outline-primary btn-lg" href="showDevices" role="button">Device list</a>
<a class="btn btn-outline-success btn-lg" href="addDevice.jsp" role="button">Add new device</a>
</div>


<jsp:include page="/ConnServlet"></jsp:include>
